// NLisence.cpp: implementation of the CNLisence class.
//
//
//  
//
...
/*    if (str[iu]=='#'){ str[iu] = '+';}
    ...
    if (repla[iu]=='+'){ str[iu] = 'Z';}
    if (repla[iu]=='='){ str[iu] = 'N';}
    if (repla[iu]=='M'){ str[iu] = '0';}
    if (repla[iu]=='n'){ str[iu] = '8';}
    if (repla[iu]=='a'){ str[iu] = '6';}
    if (repla[iu]=='e'){ str[iu] = '4';}
    if (repla[iu]=='w'){ str[iu] = '2';}
    if (repla[iu]=='k'){ str[iu] = '5';}
    if (repla[iu]=='q'){ str[iu] = '7';}
