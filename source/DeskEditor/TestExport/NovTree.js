...
//
  ...
  if (level>0) 
    ...
    { 
      if (browserVersion == 1) { 
         this.renderOb(leftSide + "<img name='nodeIcon" + this.id + "' src='mlastnode.gif' width=16 height=22 border=0 onClick ='clickOnNode("+this.id+")' alt='  '>") 
      } else {
    ...
    { 
      if (browserVersion == 1) { 
         this.renderOb(leftSide + "<img name='nodeIcon" + this.id + "' src='mnode.gif' width=16 height=22 border=0 onClick ='clickOnNode("+this.id+")' alt='  '>") 
      } else {
...
{ 
  ...
  this.outputLink()
      if (browserVersion == 1) { 
         ...
         doc.write("src='" + this.iconSrc+"' border=0 onClick='clickOnNode("+this.id+")' alt='  ' >") 
      } else {   
         doc.write(auxEv +"<img name='folderIcon" + this.id + "' ") 
      ...
      if (this.id == 0 )
	{
      ...
      if (browserVersion == 1) { 
	doc.write("<img src='outplus.jpg'  alt='Show all folders' border =1 onClick='ShowAll()'>")
	doc.write(" ")
        doc.write("<img src='outminus.jpg' alt = 'Hide all folders' border = 1 onClick='CloseAll()' >")
      } else {
