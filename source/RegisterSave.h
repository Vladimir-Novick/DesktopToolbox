...
public:
	...
	void UserKeyStore(const char *key,char *value,unsigned long LenRead,Storage StoreFlag);
	void UserKeyStore(const char *key,long *value,unsigned long LenRead,Storage StoreFlag);

	void UserKeyStore(char *key,long &value,Storage StoreFlag);
	void UserKeyStore(char *key,int &value,Storage StoreFlag);	
